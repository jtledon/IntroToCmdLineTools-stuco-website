...
Branches are just tags that refer to a specific commit. If you make a new commit while attatched to a specific branch, it will update the ref of the branch
...
This is a shell based alias/expansion that allows the letter `g` to expand into `git`. This is a super useful timesave when youre typing the word `git` hundreds of times a day
...
<Image
    src={lga}
    alt="Impage of output of git lga in my dotfiles repo"
    width="1000"
    height="300"
/>
